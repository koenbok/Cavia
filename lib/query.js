(function() {
  ...
  Query = (function() {
    ...
    function Query(table, input, options) {
      var column, key, operator, result, v, value, values, _i, _j, _len, _len2, _ref, _ref2;
      this.table = table;
      this.input = input;
      ...
      for (key in _ref) {
        ...
        column = key[0];
        operator = key[1];
        if (!column || !operator) throw new Error("Invalid query key: " + key);
  ...
  exports.SelectQuery = (function(_super) {
    ...
    function SelectQuery() {
      SelectQuery.__super__.constructor.apply(this, arguments);
    }
  ...
  exports.DeleteQuery = (function(_super) {
    ...
    function DeleteQuery() {
      DeleteQuery.__super__.constructor.apply(this, arguments);
    }
